document.addEventListener('DOMContentLoaded', () => {
    const carousel = document.querySelector('[data-transport-carousel]');
    if (!carousel) return;

    const track = carousel.querySelector('[data-transport-track]');
    const cards = Array.from(carousel.querySelectorAll('[data-transport-card]'));
    const prevButton = carousel.querySelector('.transport-carousel-prev');
    const nextButton = carousel.querySelector('.transport-carousel-next');
